...
class ModelBase(nn.Module, ABC):
    def __init__(
        ...
        **common_args,
        ...
        # Extract model_name from common_args before passing to instantiate
        model_name_from_args = common_args.pop("model_name", None)
        ...
        # Set self.model_name based on provided argument or default from model_root
        if model_name_from_args:
            self.model_name = model_name_from_args
        else:
