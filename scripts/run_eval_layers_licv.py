...
@hydra.main(config_path="../src/config", config_name="eval_ffn.yaml", version_base=None)
def main(cfg: DictConfig):
    ...
    for current_layers in layers_to_iterate:
        ...
        # 构建完整的命令行，直接调用 eval_licv.py
        command = [
            sys.executable,
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "src", "eval_licv.py"),
        ] + hydra_overrides
